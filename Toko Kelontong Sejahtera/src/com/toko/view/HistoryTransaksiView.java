 ...
 * @author Alfian
 */
public class HistoryTransaksiView extends javax.swing.JFrame {
    ...
    /**
     * Creates new form HistoryTransaksiView
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HistoryTransaksiView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new HistoryTransaksiView().setVisible(true);
            }
        });
    }
